...
abstract class GenerateSchemeTask : DefaultTask() {
    ...
    fun generate() {
        ...
        val tlSchemaFilter = tlSchemaFull.applyRules(TlRules.rules)
        ...
        val dep = TlRules.rules.databaseTypes
    ...
    private fun generateSchemeClassForType(
        ...
        for (constructor in constructors) {
            ...
            if (!TlRules.rules.filterConstructor(constructor.tl.key.name)) continue
